...
Used to encrypt and store raw files in the object store. See [Encrypted Object Store ](/docs/pb/p8e/overview/encrypted-object-store)for additional information.
...
To follow along, <a href="/sample.pdf" target="_blank">download this `sample.pdf`</a> file
or use any file on your machine.
