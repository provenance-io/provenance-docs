...
Used to encrypt and store objects in the object store. See [Encrypted Object Store ](https://developer.provenance.io/docs/pb/p8e/overview/encrypted-object-store)for additional information.
