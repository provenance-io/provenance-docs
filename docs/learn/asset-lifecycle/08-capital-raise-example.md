...
process, the cap table for the fund will be established as an Investment [Marker](/docs/sdk/marker/)
...
the delegator community. Once the vote is passed, the contract's [WASM](/docs/sdk/z-smart-contracts/) binary is stored on the blockchain. Each time a fund
